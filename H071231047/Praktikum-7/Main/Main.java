        ...
        while (true) {
            ...
            switch (pilihan) {
                ...
                // Input anak (jika sudah menikah)
                    ...
                    pengalamanObjek.jenisPekerjaan(jenisPekerjaan, masaKerja);
                    ...
                    switch (projek) {
                        case 1:
                            projekObjek.jumlahProjek(4);
                            break;
                        case 2:
                            projekObjek.jumlahProjek(8);
                            break;
                        case 3:
                            projekObjek.jumlahProjek(12);
                            break;
                        case 4:
                            projekObjek.jumlahProjek(16);
                            break;
                    }
